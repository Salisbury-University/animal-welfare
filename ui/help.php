...
<main><!-- Main jumbotron for a primary marketing message or call to action -->
    <div class="jumbotron">
        <div class="container">
            <h1 class="display-4 font-weight-bold text-white">Welcome! <small>Review the following sections for
                    help:</small></h1>
            <div class="row">
                <div class="col">
                    ...
                    <p class="text-white">
                        Animals can be looked up by name, species, location, or ISIS. All animals matching the search
                        will appear in the results box.
                        <br><br> Admin can add, update, and delete animals from this page.
                    </p>
                    <p class="text-white font-weight-bold">Animal Profile:</p>
                    <p class="text-white">
                        Each animal has its own profile displaying their: name, ID, location, species, sex, acquisition
                        date, birthdate,
                        and the date of the last form submitted. Clicking ‘new entry’ brings you to the animals’
                        assigned welfare form.
                ...
                if ($user->checkIsAdmin() == true) { ?>
                    ...
                    <div class="col">
                        ...
                        <p class="text-white">All users and their passwords are displayed. Passwords are hashed meaning you
                            cannot see them for security purposes.
                            Users can be deleted and modified from the table. Deleting is irreversible! Only a users
                            password and admin setting
                            can be updated.</p>
