                            ...
                            <div class="card-body">
                                <form method="POST">
                                    ...
                                    <div class="card-footer text-center">
                                        <button type="submit" action="animalProfile.php?id=<?php echo $zim;?>" name="sub" class="btn btn-primary mt-3">Submit</button>
                                </form>
                            </div>
                        </div>
                    </div>
...
if (isset($_POST['sub'])) {
    ...
    if($unit == NULL || $food == NULL || $reason == NULL || $quantitygiv == NULL || $quantityeat == NULL){
        echo "<script> alert('Invalid Response Detected') </script>";
        header("Refresh:0");
    }
/*
    echo $unit;
