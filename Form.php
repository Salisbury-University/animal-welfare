<!-- /*
May 4 - Added the contenteditable tag to the table so each field is editable(form name, section title, and question
text)
- All that is needed is to add a listener on isset for the Submit button to take the id for each text and what type of
text it is (form, section, question)
